...
SHMEM_INTERNAL_ENV_DEF(ADAPTIVE_THREAD_SCHEDULE, long, 0, SHMEM_INTERNAL_ENV_CAT_OTHER,
...
SHMEM_INTERNAL_ENV_DEF(THREAD_SCHEDULE_POLICY, long, 2, SHMEM_INTERNAL_ENV_CAT_OTHER,
                       "Specify thread schedule policy")
